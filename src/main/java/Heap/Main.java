...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        SortTestHelper.testSort("sort.MergeSort", arr1);
        SortTestHelper.testSort("sort.QuickSort", arr2);
        SortTestHelper.testSort("sort.QuickSort2", arr3);
        SortTestHelper.testSort("sort.QuickSort3Ways", arr4);
        SortTestHelper.testSort("Heap.HeapSort1", arr5);
        SortTestHelper.testSort("Heap.HeapSort2", arr6);
        ...
        //SortTestHelper.testSHeaport("sort.QuickSort", arr2);
        SortTestHelper.testSort("sort.QuickSort2", arr3);
        SortTestHelper.testSort("sort.QuickSort3Ways", arr4);
        SortTestHelper.testSort("Heap.HeapSort1", arr5);
        SortTestHelper.testSort("Heap.HeapSort2", arr6);
